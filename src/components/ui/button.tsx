...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-semibold transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:bg-neutral-100 disabled:from-neutral-100 disabled:to-neutral-100 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 disbled:text-neutral-300 border border-neutral-200 shadow-sm",
  {
    variants: {
      variant: {
        primary:
          "bg-gradient-to-t from-[#039be5] to-[#29b6f6] text-primary-foreground hover:from-blue-700 hover:to-blue-700",
        destructive:
        ...
        secondary:
          "bg-white text-blak hover:bg-neutral-100",
      ...
      size: {
        ...
        ssm: "h-7 rounded-md px-2 text-xs",
